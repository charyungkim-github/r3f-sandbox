...
const fragmentShader = `
    ...
    void main() {
        ...
        vec2 uv1 = vUv * repeatTexture1;
        vec2 uv2 = vUv * repeatTexture2;
        vec2 uv3 = vUv * repeatTexture3;
        vec2 uv4 = vUv * repeatTexture4;
...
export const SplattingMaterial = shaderMaterial(
  {
    texture1: null,
    texture2: null,
    texture3: null,
